...
class Simulation(Simulatable):
    ...
    def simulate(self):
        ...
        #Solarthermal
        self.solarthermal_power_theo = list()
        ...
        # Heat storage        
        self.heat_storage_temperature_distribution = list()
        self.heat_storage_temperature_mean = list()
        self.heat_storage_temperature_min = list()
        self.heat_storage_temperature_max = list()
        self.heat_storage_temperature_output = list()
        self.heat_storage_temperature_solve = list()
        self.heat_storage_temperature_water_flow = list()
        self.heat_storage_temperature_heating_flow = list()
        self.heat_storage_volume_flow_rate_water = list()
        self.heat_storage_volume_flow_rate_heating = list()
        ...
        if self.needs_update:
            ...
            for t in range(0, self.simulation_steps):
                ...
                self.solarthermal.temperature_heat_storage = min(self.heat_storage.temperature_output)#self.heat_storage.temperature_mean
                self.aux_component.temperature_heat_storage = min(self.heat_storage.temperature_output)#self.heat_storage.temperature_mean
                
                ## Get solarthermal input tempertaure from heat storage class
                self.solarthermal.temperature_input = self.heat_storage.temperature_output[0]
                ...
                self.solarthermal_power_theo.append(self.solarthermal.power_theo)
                ...
                # Heat storage
                self.heat_storage_temperature_distribution.append(self.heat_storage.temperature_distribution)
                self.heat_storage_temperature_mean.append(self.heat_storage.temperature_mean)
                self.heat_storage_temperature_min.append(min(self.heat_storage.temperature_distribution))
                self.heat_storage_temperature_max.append(max(self.heat_storage.temperature_distribution))
                self.heat_storage_temperature_solve.append(self.heat_storage.storage_temperature_solve)
                self.heat_storage_temperature_output.append(self.heat_storage.temperature_output)                
                self.heat_storage_temperature_water_flow.append(self.heat_storage.temperature_output[3])
                self.heat_storage_temperature_heating_flow.append(self.heat_storage.temperature_output[2])
                self.heat_storage_volume_flow_rate_water.append(self.heat_storage.volume_flow_rate_water)
                self.heat_storage_volume_flow_rate_heating.append(self.heat_storage.volume_flow_rate_heating)
